...
void setup() {
  ...
  rainbow = loadImage("RainbowPictureGrace.png");  // 2. Change this to match your file name. 
...
background(rainbow);
  ...
  unicorn = loadImage("GraceUnicornPicture.png"); // 5. Change this to match your file name.
}
